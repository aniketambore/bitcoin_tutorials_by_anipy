...
![Demo](https://i.ibb.co/T4v4j69/Clipboard-Monitoring-for-Bitcoin-Addresses-in-Flutter.gif)
...
![Clipboard Dialog](https://i.ibb.co/6gvyBVH/blue-wallet-clipboard-dialog.jpg)
...
![Main Screen](https://i.ibb.co/z5D5N8F/Screenshot-1704017539.png)
...
![Clipboard Dialog](https://i.ibb.co/YPgVs6d/Screenshot-1704017829.png)

Click on "Continue" in the dialog, and the main screen will update accordingly:

![Main Screen Updated](https://i.ibb.co/27TR4yC/Screenshot-1704017852.png)
